...
declare -A DATASETS=(
  ...
  #[refseq]="/WORKS/vlevallois/data/dataset_refseq/fof_kmindex.list:9869292" refseq datasets needs to open 800k files, which is too much for our cluster, we proceed it differently, see build_kmindex_refseq.sh
)
